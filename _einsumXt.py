'''
_einsum.py copied from cupy/main repo
...
def reduced_binary_einsumXt(libcublas,handle,arr0, sub0, arr1, sub1, sub_others):
    set0 = set(sub0)
    set1 = set(sub1)
    ...
    arr_out = matmulXt(libcublas,handle,tmp0, tmp1).reshape(shapes_out)
...
def einsum(*operands,devices,**kwargs):
    ...
    set_cublas_device(libcublas, handle, devices)
